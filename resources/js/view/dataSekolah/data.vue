                ...
                >
                    ...
                    <template v-slot:cell(actions)="row">
                        ...
                        <button
                            ...
                            @click.prevent="deleteSchool(row.item.id)"
                        >
...
export default {
    ...
    data() {
        return {
            fields: [
                ...
                { key: "jenjang_pend", label: "Jenjang Pendidikan" },
    ...
    watch: {
        page() {
            this.getSchool(); //MAKA FUNGSI INI DIJALANKAN
        },
        search() {
    ...
    methods: {
        ...mapActions("school", ["getSchool",'removeSchool']),
        reloadPage() {
            location.reload();
            this.getSchool();
        },
